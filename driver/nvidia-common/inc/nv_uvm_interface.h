...
/*******************************************************************************
    ...
    This function accepts gpu address space handles, both are required.

    If indirect access is reported, the contents of peerIds are undefined.
    ...
    Arguments:
        ...
        totalLinkLineRateMBps[OUT] - Maximum unidirectional bandwidth between
                                     the peers in megabytes per second
