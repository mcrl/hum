...
{
    NvU64 addresses[NV_IOCTL_NUMA_INFO_MAX_BLACKLIST_ADDRESSES] NV_ALIGN_BYTES(8);
    NvU32 numEntries;
...
#define NV_FLAG_BLACKLIST              0x0002
...
NV_STATUS NV_API_CALL   nv_register_phys_pages   (nv_state_t *, NvU64 *, NvU64, void **);
...
void NV_API_CALL nv_control_irq(nv_state_t *, NvBool bEnable);
...
NV_STATUS  NV_API_CALL  rm_blacklist_adapter     (nvidia_stack_t *, nv_state_t *);
...
NV_STATUS  NV_API_CALL rm_get_gpu_numa_info(nvidia_stack_t *, nv_state_t *, NvS32 *, NvU64 *, NvU64 *, nv_blacklist_addresses_t *);
...
void       NV_API_CALL rm_handle_display_change(nvidia_stack_t *, nv_state_t *);
...
NV_STATUS  NV_API_CALL  nv_vgpu_get_type_info(nvidia_stack_t *, nv_state_t *, NvU32, NvU8 *, int, NvU8);
...
NV_STATUS  NV_API_CALL  nv_vgpu_update_request(nvidia_stack_t *, const NvU8 *, NvU32, NvU64 *, NvU64 *, NvU8 *);
